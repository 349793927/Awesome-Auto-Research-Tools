...
| 项目 | Stars | 框架 / 工具 | 支持的 LLM API | 简介 |
|------|-------|-------------|----------------|------|
| [claude-scientific-skills](https://github.com/K-Dense-AI/claude-scientific-skills) | <img src="https://img.shields.io/github/stars/K-Dense-AI/claude-scientific-skills?style=for-the-badge" height="36"> | PyTorch Lightning, scikit-learn, BioPython, RDKit, DeepChem, Modal | Agent 无关（Claude Code, Codex, Gemini CLI, Cursor, OpenCode） | 170+ 即用型科学 skills，覆盖生物、化学、医学、材料和地球科学。 |
