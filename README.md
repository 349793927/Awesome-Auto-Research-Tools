...
**📅 Star counts last verified: 2026-03-20**
...
| [AIDE](https://github.com/WecoAI/aideml) | <img src="https://img.shields.io/github/stars/WecoAI/aideml?style=for-the-badge" height="36"> | Python, Streamlit, Docker | OpenAI (GPT-4-turbo/4o), Anthropic Claude, Gemini, Ollama (local) | AI-Driven Exploration in the Space of Code. LLM agent that writes, evaluates, and improves ML code via agentic tree search. 4x more Kaggle medals than best linear agent. |
...
| Project | Stars | Framework / Tools | Supported LLM APIs | Description |
|---------|-------|-------------------|---------------------|-------------|
| [claude-scientific-skills](https://github.com/K-Dense-AI/claude-scientific-skills) | <img src="https://img.shields.io/github/stars/K-Dense-AI/claude-scientific-skills?style=for-the-badge" height="36"> | PyTorch Lightning, scikit-learn, BioPython, RDKit, DeepChem, Modal | Agent-agnostic (Claude Code, Codex, Gemini CLI, Cursor, OpenCode) | 170+ ready-to-use scientific skills across biology, chemistry, medicine, materials, and earth science. |
